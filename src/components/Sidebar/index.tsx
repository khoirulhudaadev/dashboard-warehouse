...
import { DeliveryBox01Icon, Home01Icon, InboxDownloadIcon, InboxUploadIcon, LeftToRightListNumberIcon, PackageSearchIcon, UserIcon, UserSquareIcon } from 'hugeicons-react';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        ...
        <NavLink to="/">
          <h1 className='text-white m-2 w-full mb-0 font-semibold text-[32px]'>WareHouse</h1>
        </NavLink>
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-4 flex flex-col gap-4">
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('halaman-utama') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <Home01Icon className='text-white w-5' />
                  Halaman utama
                </NavLink>
              </li>
              {/* <!-- Menu Halaman Utama --> */}
              ...
              {/* <!-- Menu Jumlah barang masuk --> */}
              <li>
                <NavLink
                  to="/barang-masuk"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('barang-masuk') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <InboxDownloadIcon className='text-white w-5' />
                  Barang masuk
                </NavLink>
              </li>
              {/* <!-- Menu Jumlah barang masuk --> */}

              {/* <!-- Menu Jumlah barang keluar --> */}
              <li>
                <NavLink
                  to="/barang-keluar"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('barang-keluar') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <InboxUploadIcon className='text-white w-5' />
                  Barang keluar
                </NavLink>
              </li>
              {/* <!-- Menu Jumlah barang keluar --> */}
              ...
              <li>
                <NavLink
                  to="/jenis-barang"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('jenis-barang') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <PackageSearchIcon className='text-white w-5' />
                  Jenis barang
                </NavLink>
              </li>
              {/* <!-- Menu Jenis Barang --> */}
              ...
              <li>
                <NavLink
                  to="/satuan-barang"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('satuan-barang') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <LeftToRightListNumberIcon className='text-white w-5' />
                  Satuan barang
                </NavLink>
              </li>
              {/* <!-- Menu Satuan Barang --> */}
              ...
              <li>
                <NavLink
                  to="/pengelolaan-pengguna"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('pengelolaan-pengguna') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <UserSquareIcon className='text-white w-5' />
