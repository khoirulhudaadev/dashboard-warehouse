import { Home01Icon, InboxDownloadIcon, InboxUploadIcon, LeftToRightListNumberIcon, PackageSearchIcon, UserIcon, UserSquareIcon } from 'hugeicons-react';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        ...
        <NavLink to="/">
          <h1 className='text-white m-2 w-full mb-0 font-semibold text-[32px]'>GudangKu</h1>
        </NavLink>
            ...
            <ul className="mb-4 flex flex-col gap-4">
              ...
              <li>
                <NavLink
                  to="/data-barang"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('data-barang') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
